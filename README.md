...
⚠️ Important: MultipeerConnectivity does not work reliably in the Simulator.
...
A UI-facing coordinator that:
	...
	•	ensures all UI updates occur on the main actor
...
(for this app, reliability was preferred over complexity)
...
MIT
Use it, fork it, improve it — and please share fixes.
